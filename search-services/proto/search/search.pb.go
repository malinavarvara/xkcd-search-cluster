...
func (x *SearchResponse) GetComics() []*Comics {
	if x != nil {
		return x.Comics
	}
	return nil
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\x06Search\x127\n" +
	"\x06Search\x12\x15.search.SearchRequest\x1a\x16.search.SearchResponse\x126\n" +
	"\x04Ping\x12\x16.google.protobuf.Empty\x1a\x16.google.protobuf.Empty\x128\n" +
	"\aISearch\x12\x15.search.SearchRequest\x1a\x16.search.SearchResponseB\x1fZ\x1dyadro.com/course/proto/searchb\x06proto3"
...
var file_proto_search_search_proto_depIdxs = []int32{
	2, // 0: search.SearchResponse.comics:type_name -> search.Comics
	...
	1, // 6: search.Search.ISearch:output_type -> search.SearchResponse
